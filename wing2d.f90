...
!      The program starts here!
       ...
       !CALL SAVEXWNODE(TIMESTEP, XWNODE, "xwnode")
       CALL SAVEDPHIW(TIMESTEP, DPHIW, "DPHIW")
       !WRITE(*,*) DPHIW
	   !WRITE(*,*) PHI
	   !WRITE(*,*) XWNODE
END PROGRAM

SUBROUTINE SAVEDPHIW(TIMESTEP, DPHIW, FNAME)
...
SUBROUTINE SAVEXWNODE(TIMESTEP, XWNODE, FNAME)
      INTEGER, INTENT(IN) :: TIMESTEP
      REAL(KIND=8), DIMENSION(TIMESTEP,2), INTENT(IN) :: XWNODE
      CHARACTER :: FNAME*128
      OPEN(UNIT=11, FILE=FNAME)
      WRITE(11,1001) XWNODE
      CLOSE(UNIT=11)
 1001 FORMAT('',F15.6,2X)
END SUBROUTINE
